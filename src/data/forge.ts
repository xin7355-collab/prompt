...
export const FORGE_AXES: ForgeAxis[] = [
  ...
  // ── 服裝 ────────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      // 魅力／寫真路線（皆為著衣造型）
      { zh: '蕾絲內衣套裝', en: 'a lace lingerie set' },
      { zh: '絲質睡袍', en: 'a silk robe' },
      { zh: '緞面睡衣', en: 'satin sleepwear' },
      { zh: '浴袍', en: 'a bathrobe' },
      { zh: '高衩旗袍', en: 'a high-slit qipao' },
      { zh: '露背晚禮服', en: 'a backless evening gown' },
      { zh: '緊身皮衣', en: 'a skin-tight leather catsuit' },
      { zh: '乳膠緊身衣', en: 'a glossy latex bodysuit' },
      { zh: '透視薄紗外罩', en: 'a sheer chiffon cover-up over the outfit' },
      { zh: '短版上衣配熱褲', en: 'a crop top and denim shorts' },
      { zh: '運動內衣配緊身褲', en: 'a sports bra and leggings' },
      { zh: '瑜伽套裝', en: 'a fitted yoga set' },
      { zh: '健身房穿搭', en: 'gym wear, tank top and shorts' },
      { zh: '啦啦隊服', en: 'a cheerleader uniform' },
      { zh: '兔女郎裝', en: 'a bunny-girl outfit with bow tie' },
      { zh: '空服員制服', en: 'a flight attendant uniform' },
      { zh: '護理師服', en: 'a nurse uniform' },
      { zh: '女警制服', en: 'a police uniform' },
      { zh: '教師套裝', en: 'a teacher’s blouse and pencil skirt' },
      { zh: '秘書套裝', en: 'a secretary blouse and fitted skirt' },
      { zh: '浴衣', en: 'a summer yukata' },
      { zh: '肚皮舞裝', en: 'a belly-dance costume with coin belt' },
      { zh: '探戈舞裙', en: 'a tango dress with a thigh slit' },
      { zh: '芭蕾舞衣', en: 'a ballet leotard and tutu' },
      { zh: '拉丁舞裙', en: 'a fringed latin dance dress' },
      { zh: '淋濕的白襯衫', en: 'a rain-soaked white shirt' },
      { zh: '寬鬆男友襯衫', en: 'an oversized boyfriend shirt' },
      { zh: '針織短裙套裝', en: 'a knit crop top and mini skirt' },
      { zh: '吊帶襪長靴', en: 'thigh-high stockings with garter straps' },
      { zh: '和風巫女服', en: 'a miko shrine-maiden outfit' },
      { zh: '哥德蘿莉', en: 'a gothic lolita dress' },
      { zh: '龐克網襪', en: 'punk outfit with fishnet stockings' },
      { zh: '沙灘罩衫', en: 'a beach cover-up over a swimsuit' },
    ],
  },
  {
    key: 'outfitColor',
  ...
  // ── 姿勢與氣質 ──────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      // 魅力／寫真
      { zh: '側躺撐頭', en: 'reclining on one side, head propped on a hand' },
      { zh: '跪坐回眸', en: 'kneeling, turning to look back over the shoulder' },
      { zh: '抬手撩髮', en: 'one hand lifting the hair back' },
      { zh: '雙手舉高伸展', en: 'both arms raised overhead, body stretched long' },
      { zh: '手撫鎖骨', en: 'fingertips resting at the collarbone' },
      { zh: '倚門而立', en: 'leaning in a doorway, weight on one hip' },
      { zh: '單腳抵牆', en: 'leaning against a wall with one foot flat on it' },
      { zh: '坐姿翹腿', en: 'seated with legs crossed at the knee' },
      { zh: '趴臥抬腿', en: 'lying on the front, lower legs lifted and crossed' },
      { zh: '背對回眸', en: 'seen from behind, glancing back at the camera' },
      { zh: '拉起裙襬', en: 'lifting the hem of the skirt slightly' },
      { zh: '慵懶伸懶腰', en: 'stretching lazily after waking' },
      { zh: '勾手招喚', en: 'beckoning with one finger' },
      { zh: '低頭抿唇凝視', en: 'chin lowered, lips pressed, eyes up at the camera' },
      { zh: '雙手撐地前傾', en: 'leaning forward on both hands' },
      { zh: '坐地屈膝', en: 'seated on the floor, knees drawn up' },
      { zh: '水中回望', en: 'waist-deep in water, looking back' },
      // 柔軟度／伸展
      { zh: '一字馬橫劈', en: 'holding a full side split' },
      { zh: '縱向劈腿', en: 'holding a front split' },
      { zh: '抬腿壓筋', en: 'one leg raised high against a barre, stretching the hamstring' },
      { zh: '下腰橋式', en: 'in a backbend bridge' },
      { zh: '瑜伽下犬式', en: 'in downward dog pose' },
      { zh: '瑜伽戰士二式', en: 'in warrior II pose' },
      { zh: '瑜伽樹式', en: 'in tree pose, balanced on one leg' },
      { zh: '瑜伽鴿式', en: 'in pigeon pose' },
      { zh: '瑜伽輪式', en: 'in wheel pose' },
      { zh: '前彎觸地', en: 'folded forward, hands flat on the floor' },
      { zh: '平板支撐', en: 'holding a plank' },
      { zh: '深蹲', en: 'in a deep squat' },
      { zh: '仰臥抬腿', en: 'lying on the back with legs raised' },
      { zh: '體操落地定格', en: 'sticking a gymnastics landing, arms raised' },
      { zh: '芭蕾單腿站立', en: 'balanced on one leg in an arabesque' },
      // 動態
      { zh: '甩髮回身', en: 'whipping the hair around mid-turn' },
      { zh: '水花飛濺', en: 'bursting up out of the water, spray flying' },
      { zh: '拳擊架式', en: 'in a boxing guard' },
      { zh: '高踢腿', en: 'throwing a high kick' },
      { zh: '舞蹈定格', en: 'frozen at the peak of a dance move' },
    ],
  },
  {
    key: 'footPose',
    label: '足部動作',
    hint: '搭配下面「取景」選足部／腿部特寫，模型才會真的把鏡頭放到腳上。',
    options: [
      { zh: '赤足踮腳', en: 'barefoot, up on the toes' },
      { zh: '腳尖繃直', en: 'toes pointed, arch extended' },
      { zh: '足弓弓起', en: 'a high arched foot' },
      { zh: '腳趾微蜷', en: 'toes lightly curled' },
      { zh: '雙腳交疊', en: 'ankles crossed' },
      { zh: '盤腿而坐', en: 'sitting cross-legged' },
      { zh: '單腳抬起', en: 'one foot lifted off the ground' },
      { zh: '腳踩台階', en: 'one foot up on a step' },
      { zh: '雙腿交叉站姿', en: 'standing with legs crossed' },
      { zh: '正在脫高跟鞋', en: 'slipping off a high heel' },
      { zh: '鞋跟勾在指尖', en: 'a heel dangling from one fingertip' },
      { zh: '腳浸在水中', en: 'feet dipped in water' },
      { zh: '踩在沙灘上', en: 'bare feet in the sand' },
      { zh: '腳踏花瓣', en: 'bare feet among scattered petals' },
      { zh: '穿戰靴踩踏', en: 'planting a combat boot firmly' },
      { zh: '芭蕾足尖立起', en: 'rising en pointe in ballet shoes' },
    ],
  },
  {
    key: 'skin',
    label: '膚質狀態',
    options: [
      { zh: '乾爽自然', en: 'clean, natural skin' },
      { zh: '微微出汗', en: 'a light sheen of sweat on the skin' },
      { zh: '大量汗珠', en: 'beads of sweat running down the skin' },
      { zh: '運動後泛紅', en: 'skin flushed from exertion' },
      { zh: '剛出水濕身', en: 'wet skin, water still running off' },
      { zh: '油亮打光', en: 'oiled skin catching the light' },
      { zh: '雨中淋濕', en: 'soaked by rain, hair clinging' },
      { zh: '蒸氣氤氳', en: 'skin damp in warm steam' },
      { zh: '沾附細沙', en: 'fine sand clinging to damp skin' },
      { zh: '雞皮疙瘩', en: 'goosebumps from the cold' },
      { zh: '自然毛孔質感', en: 'natural pores and fine skin texture, no plastic smoothing' },
    ],
  },
  {
    key: 'mood',
    ...
    options: [
      ...
      { zh: '挑眉勾引', en: 'one eyebrow raised in invitation' },
      { zh: '半瞇眼凝視', en: 'a heavy-lidded, smouldering gaze' },
      { zh: '輕咬下唇', en: 'lightly biting the lower lip' },
      { zh: '狐媚淺笑', en: 'a sly, coquettish smile' },
      { zh: '飛吻', en: 'blowing a kiss' },
      { zh: '羞澀低頭', en: 'looking down, shy and flushed' },
      { zh: '冷豔不屑', en: 'an icy, disdainful beauty' },
      { zh: '慵懶睡眼', en: 'drowsy, half-awake eyes' },
      { zh: '挑逗淺笑', en: 'a teasing half-smile' },
      { zh: '嘟嘴撒嬌', en: 'pouting playfully' },
      { zh: '睥睨驕傲', en: 'looking down the nose, proud' },
      { zh: '喘息專注', en: 'breathing hard, intensely focused' },
      { zh: '眼神放空', en: 'a distant, unfocused stare' },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      { zh: '腿部特寫', en: 'a close-up of the legs' },
      { zh: '足部特寫', en: 'a close-up of the feet' },
      { zh: '鞋履特寫', en: 'a close-up of the footwear' },
      { zh: '腰臀曲線', en: 'a close crop on the waist and hip line' },
      { zh: '背影', en: 'seen from behind, back to the camera' },
      { zh: '手部特寫', en: 'a close-up of the hands' },
      { zh: '鎖骨頸線特寫', en: 'a close-up of the neck and collarbone' },
      { zh: '側臉特寫', en: 'a profile close-up' },
      { zh: '眼部特寫', en: 'an extreme close-up of the eyes' },
      { zh: '唇部特寫', en: 'an extreme close-up of the lips' },
      { zh: '髮絲特寫', en: 'a close-up of the hair' },
    ],
  },
  {
    key: 'camera',
    label: '鏡頭角度',
    options: [
      { zh: '平視', en: 'shot at eye level' },
      { zh: '低角度仰視', en: 'a low angle looking up' },
      { zh: '高角度俯視', en: 'a high angle looking down' },
      { zh: '地面視角', en: 'a ground-level camera' },
      { zh: '過肩視角', en: 'an over-the-shoulder view' },
      { zh: '荷蘭傾斜角', en: 'a canted dutch angle' },
      { zh: '魚眼廣角', en: 'a fisheye wide angle' },
      { zh: '長焦壓縮', en: '200mm telephoto compression' },
      { zh: '微距', en: 'a macro lens' },
    ],
  },
  {
    key: 'style',
...
export const RANDOMISABLE = new Set([
  ...
  'pose', 'footPose', 'skin', 'mood', 'scene', 'shot', 'camera', 'style', 'light',
]);
